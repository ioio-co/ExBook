...
### ~~🟡 7. `\myPageFormat` 魔法数字~~（已完成）
现为按名派发：每个版式一个 `\exbook@setup@<版式名>` 宏，
类末尾 `\csname exbook@setup@\exbook@format\endcsname` 一行分派；
新增版式 = 新增一个 setup 宏 + 声明同名选项。
...
| ~~第三批~~ | ~~4、5、6~~ | ✅ 已完成 |
| ~~第四批~~ | ~~7、8~~ | ✅ 已完成 |
| 按需 | 9、10、11、14、15、18、19、20、21、22 | 视维护意愿与时间 |
